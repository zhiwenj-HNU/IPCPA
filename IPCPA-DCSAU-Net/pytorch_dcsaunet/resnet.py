...
class Bottleneck(nn.Module):       #model = ResNet(Bottleneck, [2, 2, 2, 2],...)
    """ResNet Bottleneck
    """
    expansion = 4
    def __init__(self, inplanes, planes, stride=1, downsample=None,
                 ...
                 norm_layer=None, dropblock_prob=0.0, last_gamma=False,number=1,custom=0, IPCPA="False"):
...
#########################################################################################################
        ...
        if self.IPCPA=="True":
            ...
            #print("added IPCPA successfilly!")
#############################################################################################################
...
class ResNet(nn.Module):                                                     #model = ResNet(Bottleneck, [2, 2, 2, 2],...)
    def __init__(self, block, layers, radix=1, groups=1, bottleneck_width=64,
                 ...
                 last_gamma=False, norm_layer=nn.BatchNorm2d,IPCPA='False'):
        self.IPCPA=IPCPA  ####################################################3
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1, norm_layer=None,
        ...
        for i in range(1, blocks):      #  不同的大层之间也可以区分开添加IPCPA模块
