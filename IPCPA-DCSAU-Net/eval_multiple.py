...
if __name__ == '__main__':
    ...
    for image_id in test_files:
        print('image_id:',f'E:/resu_net/datasets/DDTI/2_preprocessed_data/stage2/images/{image_id}')
        img = cv2.imread(f'E:/resu_net/datasets/DDTI/2_preprocessed_data/stage2/images/{image_id}')   ##################################################
        print('img:', img.shape)
