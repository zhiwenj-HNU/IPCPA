# 模板序号008
# 开发时间 2023/4/4 11:32
# The same layer feature layer was probabilistically pooled using avg and max, and the ECA module was removed.
...
def IPP_ResNet_18():
    return IPP_ResNet(ECABottleneck, [2, 2, 2, 2])
def IPP_ResNet_34():
    return IPP_ResNet(ECABottleneck, [3, 4, 6, 3])
def IPP_ResNet_50():
    return IPP_ResNet(ECABottleneck, [3, 4, 6, 3])
def IPP_ResNet_101():
    return IPP_ResNet(ECABottleneck, [3, 4, 23, 3])
